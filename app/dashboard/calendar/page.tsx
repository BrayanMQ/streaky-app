          ...
          <main className="container mx-auto flex-1 px-4 py-8 max-w-full">
            <Card className="border-none bg-card shadow-xl ring-1 ring-border">
              <CardContent className="p-12 text-center">
                <p className="text-lg text-muted-foreground">{t("calendar.noHabits")}</p>
                <Button asChild className="mt-4">
                  <a href="/dashboard/habits">{t("calendar.createFirst")}</a>
                </Button>
              </CardContent>
            </Card>
          </main>
              ...
              <CardHeader className="flex flex-row items-center justify-between border-b border-border/40 bg-muted/5 px-6 py-4">
                <div className="flex items-center gap-3">
                  ...
                  <CardTitle className="text-xl font-bold tracking-tight">
                    {t(`calendar.months.${monthKeys[selectedMonth]}`)} <span className="text-muted-foreground/40">{selectedYear}</span>
                  </CardTitle>
                </div>
